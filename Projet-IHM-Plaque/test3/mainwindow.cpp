    ...
    if (db.open())
    {
        ...
        else
        {
            ...
            while (query.next())
            {
                ...
                {
                    MessageBox::information(this, "Réussi", "Réussite de l’ouverture de session");
...
void MainWindow::on_Enregistrer_clicked()
{
    if (db.open())
    {
        ...
        qry.prepare("INSERT INTO Utilisateur( Prenom, Nom, Profession, Date_Debut, Date_Fin, Plaque_Immatriculation)  VALUES(:Prenom, :Nom, :Profession, :Date_Debut, :Date_Fin, :Plaque_Immatriculation )");
